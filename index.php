        ...
        <nav class="container mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center">
                    <img src="crm/imagens/logo-1200-fb.png" alt="Logo BidFlow" width="140" height="75">
                </div>
    ...
    <section class="hero-gradient pt-32 pb-20 px-6 fade-in">
        <div class="container mx-auto text-center text-white">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-90">
                Sistema integrado de gestão de licitações e CRM desenvolvido para impulsionar seus resultados em vendas
            </p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="feature-card bg-white p-8 rounded-xl shadow-md">
                    ...
                    <p class="text-gray-600">
                        Acompanhe editais, prazos e documentação de forma organizada. Receba notificações automáticas e
                ...
                <div class="feature-card bg-white p-8 rounded-xl shadow-md">
                    ...
                    <p class="text-gray-600">
                        Alertas automáticos por email e sistema para prazos, novos editais e mudanças de status em
                        oportunidades.
                    </p>
                </div>
                ...
                <div class="feature-card bg-white p-8 rounded-xl shadow-md">
                    ...
                    <p class="text-gray-600">
                        Controle de acesso por perfil, auditoria de ações e proteção de dados sensíveis com
                        criptografia.
                    </p>
                </div>
                ...
                <div class="feature-card bg-white p-8 rounded-xl shadow-md">
                    ...
                    <p class="text-gray-600">
                        Sistema unificado com banco de dados integrado entre CRM e licitações. Informações centralizadas
                        e sincronizadas.
                    </p>
                </div>
            </div>
    ...
    <section id="benefits" class="bg-white py-20 px-6">
        <div class="container mx-auto">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                    Desenvolvido especificamente para empresas que atuam com licitações públicas e setor privado
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-10 rounded-2xl">
                    ...
                    <p class="text-gray-700 mb-6">
                        Módulo completo para acompanhamento de editais, gestão de documentos, controle de prazos e
    ...
    <section id="contact" class="hero-gradient py-20 px-6">
        <div class="container mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="mailto:contato@bidflow.com.br"
                    class="bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white hover:text-blue-800 transition">
        ...
        <div class="container mx-auto">
            <div class="grid md:grid-cols-3 gap-8">
                <div>
                    ...
                    <p class="text-sm">
                        Sistema integrado de gestão de licitações e CRM desenvolvido para empresas que buscam excelência
                        em vendas governamentais.
                    </p>
                </div>
                <div>
