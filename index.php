...
<body class="bg-gray-50">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                            <span class="text-blue-800 font-bold text-lg">
                                <img src="imagens/gustavo.png" alt="foto Gustavo">
                            </span>
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
                            <span class="text-green-800 font-bold text-lg">
                                <img src="imagens/rubens.png" alt="foto Rubens">
                            </span>
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center">
                            <span class="text-purple-800 font-bold text-lg">
                                <img src="imagens/priscilla.png" alt="foto Priscilla">
                            </span>
                        </div>
                        <div>
    ...
    <footer class="bg-gray-900 text-gray-300 py-12 px-6">
        <div class="container mx-auto">
            <div class="grid md:grid-cols-3 gap-8">
                <div>
                    <img src="crm/imagens/logo-1200-fp.png" alt="Logo BidFlow" " width=" 140" height="75">
                    <p class="text-sm">
